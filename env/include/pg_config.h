...
#define CONFIGURE_ARGS " '--prefix=/cpfs01/user/chengqinxiu/vidur/env' '--with-libraries=/cpfs01/user/chengqinxiu/vidur/env/lib' '--with-includes=/cpfs01/user/chengqinxiu/vidur/env/include' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-openssl' '--with-uuid=e2fs' '--with-system-tzdata=/cpfs01/user/chengqinxiu/vidur/env/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /cpfs01/user/chengqinxiu/vidur/env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1733427066720/work=/usr/local/src/conda/postgresql-split-17.2 -fdebug-prefix-map=/cpfs01/user/chengqinxiu/vidur/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/cpfs01/user/chengqinxiu/vidur/env/lib -Wl,-rpath-link,/cpfs01/user/chengqinxiu/vidur/env/lib -L/cpfs01/user/chengqinxiu/vidur/env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /cpfs01/user/chengqinxiu/vidur/env/include' 'CXX=x86_64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /cpfs01/user/chengqinxiu/vidur/env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1733427066720/work=/usr/local/src/conda/postgresql-split-17.2 -fdebug-prefix-map=/cpfs01/user/chengqinxiu/vidur/env=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1733427066720/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/cpfs01/user/chengqinxiu/vidur/env/lib/pkgconfig'"

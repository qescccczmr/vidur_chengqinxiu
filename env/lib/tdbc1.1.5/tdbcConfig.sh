...
# dir.
tdbc_LIB_SPEC="-L/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5 -ltdbc1.1.5"
TDBC_LIB_SPEC="-L/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5 -ltdbc1.1.5"
...
# String to pass to the linker to pick up the TDBC stub library from its
# installed directory
tdbc_STUB_LIB_SPEC="-L/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5 -ltdbcstub1.1.5"
TDBC_STUB_LIB_SPEC="-L/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5 -ltdbcstub1.1.5"
...
tdbc_STUB_LIB_PATH="/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5/libtdbcstub1.1.5.a"
TDBC_STUB_LIB_PATH="/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5/libtdbcstub1.1.5.a"
...
# headers
tdbc_INCLUDE_SPEC="-I/cpfs01/user/chengqinxiu/vidur/env/include"
TDBC_INCLUDE_SPEC="-I/cpfs01/user/chengqinxiu/vidur/env/include"
...
tdbc_LIBRARY_PATH="/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5"
TDBC_LIBRARY_PATH="/cpfs01/user/chengqinxiu/vidur/env/lib/tdbc1.1.5"

...
class SklearnExecutionTimePredictor(BaseExecutionTimePredictor):
    ...
    def _load_attention_df(self, file_path: str) -> pd.DataFrame:
        ...
        # df = pd.read_csv("/cpfs01/user/chengqinxiu/vidur/data/profiling/compute/h100/internlm/internlm2_5-20b-chat/attention.csv")
        df = df.drop_duplicates()
    ...
    def _train_compute_models(self) -> Dict[str, BaseEstimator]:
        ...
        compute_df = self._load_compute_df("/cpfs01/user/chengqinxiu/vidur/data/profiling/compute/h100/internlm/internlm2_5-20b-chat/mlp.csv")
        ...
        attention_df = self._load_attention_df("/cpfs01/user/chengqinxiu/vidur/data/profiling/compute/h100/internlm/internlm2_5-20b-chat/attention.csv")

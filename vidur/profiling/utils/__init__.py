...
def get_attention_input_combinations( 
    ...
    # 检查互斥条件
    if profile_only_prefill and profile_only_decode:
        raise ValueError("Cannot set both profile_only_prefill and profile_only_decode to True.")

    input_combinations = []

    # Chunked Prefills
    prefill_chunk_sizes_to_profile = get_attention_prefill_chunk_sizes_to_profile(max_seq_len)
    ...
    batch_sizes_to_profile = get_attention_batch_sizes_to_profile(min_batch_size, max_batch_size)
    input_combinations.extend(
